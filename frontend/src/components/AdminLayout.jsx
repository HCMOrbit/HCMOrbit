...
import { LayoutDashboard, Users, FileText, Flag, Layers, Settings as SettingsIcon, ShieldCheck, ArrowLeft, BookOpen, Mail, Calendar as CalendarIcon, Award } from "lucide-react";
...
export default function AdminLayout({ children, pendingReports = 0 }) {
  ...
  const items = [
    ...
    { to: "/admin/ecosystem-certifications", label: "Certification Watch", icon: Award },
