...
export default function CareerHub() {
  return (
    <div className="min-h-screen bg-white" data-testid="career-hub-page">
      <NavHeader />
      <PageHero
        eyebrow="HCMOrbit Career Hub"
        title="Career Hub"
        description="The dedicated space for Workday professionals to grow their careers — curated job postings, referrals from practitioners, salary insights, and interview prep led by the HCMOrbit community."
        testId="career-hero"
      />

      <main className="max-w-[1200px] mx-auto px-6 lg:px-8 py-14 lg:py-20">
