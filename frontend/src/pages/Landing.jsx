        ...
        <div className="relative max-w-[1200px] mx-auto px-6 lg:px-8 py-24 lg:py-32">
          <div className="max-w-3xl">
            ...
            <h1 className="font-heading text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.05]">
              Where HCM professionals <span className="text-[#0D9373]">connect, build,</span> and grow.
            </h1>
            <p className="mt-6 text-lg lg:text-xl text-white/70 max-w-2xl leading-relaxed">
              Ask questions, share solutions, and find your people — across Workday's entire ecosystem. Built for aspirants, practitioners, and the firms that hire them.
            </p>
            <div className="mt-8 flex flex-col sm:flex-row gap-3">
              ...
              <Link to="/community" className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-md border border-white/20 hover:border-white/40 hover:bg-white/5 text-white font-medium transition-colors" data-testid="hero-cta-browse">
                Browse posts
              </Link>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {QUOTES.map((q, i) => (
              <figure key={i} className="bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl p-7" data-testid={`quote-${q.group}`}>
                ...
                <blockquote className="mt-4 text-[#0F172A] leading-relaxed">"{q.text}"</blockquote>
