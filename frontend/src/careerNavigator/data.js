  ...
  { id:"payroll", name:"Payroll", icon:"cash", blurb:"Gross-to-net, integrations, compliance", guideCount:18, popular:true,
    stages:{ "leveling-up":{ leadsTo:["Senior Payroll Specialist","Payroll Lead"], phases:[
      { n:1, title:"Own gross-to-net", timeframe:"Months 0–3", summary:"Pay groups, earnings, deductions, and how a worker's position drives pay eligibility.",
        guides:[{docId:"PAYROLL-WDPAY-KB-001",title:"Workday Payroll architecture across HCM, benefits, time & finance"},{docId:"PAYROLL-G2N-KB-001",title:"Architecting the gross-to-net chain"}],
      ...
      { n:2, title:"Run & audit the pay calc", timeframe:"Months 3–6", summary:"Period processing, off-cycles, and reading a pay calc when a run doesn't balance.",
        guides:[{docId:"PAY-G2N-KB-001",title:"Gross-to-net troubleshooting when retro changes cross pay periods"},{docId:"PAYROLL-PAYAUD-KB-003",title:"Pre-payroll catches what post-payroll can only document"}],
      ...
      { n:3, title:"Connect payroll to the tenant", timeframe:"Months 6–9", summary:"Inbound and outbound payroll integrations, and payroll accounting through to the GL.",
        guides:[{docId:"PAYROLL-PAYINT-KB-001",title:"Payroll interface architecture across HCM, benefits, time & finance"},{docId:"PAYROLL-PAYACC-KB-001",title:"Payroll accounting architecture through to the GL"}],
      ...
      { n:4, title:"Compliance & go-live readiness", timeframe:"Months 9–12", summary:"Reporting, parallel testing, and the controls that keep payroll audit-clean.",
        guides:[{docId:"PAYROLL-PAYREP-KB-103",title:"Governance controls for scaling payroll reporting"},{docId:"PAYROLL-PAYAUD-KB-103",title:"Governance controls for scaling payroll audits"}],
        checkpoint:"Design a parallel test plan" },
    ]}, "starting-out":{leadsTo:[],phases:[]}, "going-architect":{leadsTo:[],phases:[]} } },
  { id:"core-hcm", name:"Core HCM", icon:"building", blurb:"Org design, positions, effective dating", guideCount:22, popular:false, stages:{}, categorySlug:"core-hcm" },
  { id:"integrations", name:"Integrations", icon:"plug", blurb:"Studio, Core Connectors, EIB, APIs", guideCount:16, popular:false, stages:{}, categorySlug:"integration-platform" },
  { id:"security", name:"Security", icon:"lock", blurb:"Domains, groups, SoD, audit controls", guideCount:14, popular:false, stages:{}, categorySlug:"security-compliance" },
